...
import ru.cpc.smartflatview.indicatorPackage.sensors.SensorCO;
import ru.cpc.smartflatview.indicatorPackage.sensors.SensorHumidity;
import ru.cpc.smartflatview.indicatorPackage.sensors.SensorIlluminance;
import ru.cpc.smartflatview.indicatorPackage.sensors.SensorTemperature;
...
public class RoomsParser extends DefaultHandler 
{
	...
	ArrayList<Room> getFavorites(){
		return m_cFavorites;
	}

	LinkedHashMap<String, List<Room>> getGroups(){
		return m_cGroups;
	}
...
//    }
    ...
    public void startElement(String namespaceURI, String localName, String qName, Attributes atts) {
    	...
    	try
    	{
			switch (localName) {
				case "android": {
					parseTagAndroid(atts);
					break;
				}
				case "smartflat": {
					parseTagSmartFlat(atts);
					break;
				}
				case "summary":
				...
				case "group":
					if (m_bGroupsMode) {
						...
						m_cGroups.put(m_sGroup, new ArrayList<>());
					}
					break;
				case "room":
					parseTagRoom(atts);
				...
				case "regulator":
					if (m_pSubsystem != null) {
						parseTagRegulator(atts);
					}
					break;
				case "alarmsensor":
					if (m_pSubsystem != null) {
						parseTagAlarmsensor(atts);
					}
					break;
				case "sensor":
					if (m_pSubsystem != null) {
				...
				case "climatic":
					if (m_pSubsystem != null) {
						parseTagClimatic(atts);
					}
					break;
				case "mediabutton":
					if (m_pRoom != null) {
						parseTagMediabutton(atts);
					}
					break;
				case "swing":
					if (m_pRoom != null) {
	...
	private void parseTagIDIS(Attributes atts) {
		String attrPosX = atts.getValue("x");
		int iPosX = Integer.parseInt(attrPosX);
	...
	private void parseTagMediafield(Attributes atts) {
		String attrPosX = atts.getValue("x");
		int iPosX = Integer.parseInt(attrPosX);
...
//                    int iReaction = attrReaction == null && Integer.parseInt(attrReaction) != 0;
	...
	private void parseTagClimatic(Attributes atts) {
		String attrPosX = atts.getValue("x");
		int iPosX = Integer.parseInt(attrPosX);
	...
	private void parseTagDoor2(Attributes atts) {
		String attrPosX = atts.getValue("x");
		int iPosX = Integer.parseInt(attrPosX);
	...
	private void parseTagDoor(Attributes atts) {
		String attrPosX = atts.getValue("x");
		int iPosX = Integer.parseInt(attrPosX);
	...
	private void parseTagMacro(Attributes atts) {
		String attrPosX = atts.getValue("x");
		int iPosX = Integer.parseInt(attrPosX);
...
*/
	...
	private void parseTagSensor(Attributes atts) {
		String attrPosX = atts.getValue("x");
		int iPosX = Integer.parseInt(attrPosX);
	...
	private void parseTagAlarmsensor(Attributes atts) {
		String attrPosX = atts.getValue("x");
		int iPosX = Integer.parseInt(attrPosX);
	...
	private void parseTagRegulator(Attributes atts) {
		String attrPosX = atts.getValue("x");
		int iPosX = Integer.parseInt(attrPosX);
		...
		String attrAddress3 = atts.getValue("tempaddress");
		if (attrAddress3 == null)
			attrAddress3 = "";

		String attrAddress4 = atts.getValue("stateaddress");
		if (attrAddress4 == null)
			attrAddress4 = "";
		...
		switch (iSubType) {
			...
			case 10:
			case 11:
				m_pSubsystem.AddIndicator(new Conditioner2Temp(iPosX / 10, iPosY / 10, attrName, false, bProtected, bDoubleScale, bQuick, iReaction, m_pSubsystem.m_iGridWidth, iSubType).Bind(attrAddress1, attrAddress2, attrValue1, attrValue0, bNoPower, attrValueMin, attrValueMax, attrValueMed).BindAddParam(attrAddress3, null));
				break;
			case -9:
			case -10:
			case -11:
				m_pSubsystem.AddIndicator(new Conditioner2Temp(iPosX / 10, iPosY / 10, attrName, true, bProtected, bDoubleScale, bQuick, iReaction, m_pSubsystem.m_iGridWidth, iSubType).Bind(attrAddress1, attrAddress2, attrValue1, attrValue0, bNoPower, attrValueMin, attrValueMax, attrValueMed).BindAddParam(attrAddress3, null));
				break;
			case 12:
			case 13:
			case 14:
				m_pSubsystem.AddIndicator(new Conditioner2Temp(iPosX / 10, iPosY / 10, attrName, false, bProtected, bDoubleScale, bQuick, iReaction, m_pSubsystem.m_iGridWidth, iSubType).Bind(attrAddress1, attrAddress2, attrValue1, attrValue0, bNoPower, attrValueMin, attrValueMax, attrValueMed).BindAddParam(attrAddress3, attrAddress4));
				break;
			case -12:
			case -13:
			case -14:
				m_pSubsystem.AddIndicator(new Conditioner2Temp(iPosX / 10, iPosY / 10, attrName, true, bProtected, bDoubleScale, bQuick, iReaction, m_pSubsystem.m_iGridWidth, iSubType).Bind(attrAddress1, attrAddress2, attrValue1, attrValue0, bNoPower, attrValueMin, attrValueMax, attrValueMed).BindAddParam(attrAddress3, attrAddress4));
				break;

		}
	}

	private void parseTagRelay(Attributes atts) {
		String attrPosX = atts.getValue("x");
		int iPosX = Integer.parseInt(attrPosX);
		...
		switch (iSubType) {
			case 1:
				m_pSubsystem.AddIndicator(new Lamp(iPosX / 10, iPosY / 10, attrName, false, bProtected, bDoubleScale, bQuick, iReaction, m_pSubsystem.m_iGridWidth,1).Bind(attrAddress, attrValue1, attrValue0));
				break;
			case -1:
				m_pSubsystem.AddIndicator(new Lamp(iPosX / 10, iPosY / 10, attrName, true, bProtected, bDoubleScale, bQuick, iReaction, m_pSubsystem.m_iGridWidth,1).Bind(attrAddress, attrValue1, attrValue0));
				break;
			case 2:
...
//							break;
			...
			case -9:
				...
				break;
			case 10:
				m_pSubsystem.AddIndicator(new Fountain(iPosX / 10, iPosY / 10, attrName, false, bProtected, bDoubleScale, bQuick, iReaction, m_pSubsystem.m_iGridWidth,true).Bind(attrAddress, attrValue1, attrValue0));
				break;
			case -10:
				m_pSubsystem.AddIndicator(new Fountain(iPosX / 10, iPosY / 10, attrName, true, bProtected, bDoubleScale, bQuick, iReaction, m_pSubsystem.m_iGridWidth,true).Bind(attrAddress, attrValue1, attrValue0));
				break;
			case 11:
				m_pSubsystem.AddIndicator(new Fountain(iPosX / 10, iPosY / 10, attrName, false, bProtected, bDoubleScale, bQuick, iReaction, m_pSubsystem.m_iGridWidth,false).Bind(attrAddress, attrValue1, attrValue0));
				break;
			case -11:
				m_pSubsystem.AddIndicator(new Fountain(iPosX / 10, iPosY / 10, attrName, true, bProtected, bDoubleScale, bQuick, iReaction, m_pSubsystem.m_iGridWidth,false).Bind(attrAddress, attrValue1, attrValue0));
				break;
			case 12://Диско шар
			case 13://Люстра
			case 14://Точка
			case 15://Бра
				m_pSubsystem.AddIndicator(new Lamp(iPosX / 10, iPosY / 10, attrName, false, bProtected, bDoubleScale, bQuick, iReaction, m_pSubsystem.m_iGridWidth,iSubType).Bind(attrAddress, attrValue1, attrValue0));
				break;

		}
	}

	private void parseTagSubSystem(Attributes atts) {
		String sAttrName;
	...
	private void parseTagRoom(Attributes atts) {
		if (m_bGroupsMode) {
			String attrID = atts.getValue("id");
			Log.d("XML", "room: " + attrID);
			Objects.requireNonNull(m_cGroups.get(m_sGroup)).add(m_cRoomID.get(attrID));
	...
	private void parseTagSmartFlat(Attributes atts) {
	...
	private void parseTagAndroid(Attributes atts) {
