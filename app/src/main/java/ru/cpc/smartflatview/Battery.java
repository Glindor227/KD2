...
public class Battery extends BaseRegulator
{
    ...
    {
        super(iX, iY, newDez?(posDez?R.drawable.radiator_cool_p:R.drawable.radiator_cool_2):R.drawable.radiator_cold, 5, sName, bMetaInd, bProtected, bDoubleScale, bQuick, iReaction, iScale);
    ...
    protected boolean Update()
    {
        ...
        iResId = newDez?(posDez?R.drawable.radiator_cool_p:R.drawable.radiator_cool_2):R.drawable.radiator_cold;

        if(m_iValue > m_fValueMed)
            iResId = newDez?(posDez?R.drawable.radiator_hot_p:R.drawable.radiator_hot_2):R.drawable.radiator_hot;
