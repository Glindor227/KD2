...
public class MotionSensor extends BaseAlarmSensor
{
	...
	{
		super(iX, iY,
				getIndDis(R.drawable.guard_sensor_alarm_p,R.drawable.guard_sensor_alarm,R.drawable.id076),
				getIndDis(R.drawable.guard_sensor_on_p, R.drawable.guard_sensor_on,R.drawable.id077),
				getIndDis(R.drawable.guard_sensor_off_p,R.drawable.guard_sensor_off,R.drawable.id075),
