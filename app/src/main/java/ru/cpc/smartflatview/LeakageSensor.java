...
public class LeakageSensor extends BaseAlarmSensor
{
	...
	{
		super(iX, iY,
				getIndDis(R.drawable.leakage_sensor_alarm_p,R.drawable.leakage_sensor_alarm,R.drawable.id079),
			getIndDis(R.drawable.leakage_sensor_on_p,R.drawable.leakage_sensor_on,R.drawable.id080),
			getIndDis(R.drawable.leakage_sensor_off_p,R.drawable.leakage_sensor_off,R.drawable.id081),
