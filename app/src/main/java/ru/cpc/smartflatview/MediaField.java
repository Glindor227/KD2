...
//        m_pUI.m_pText2.setTextColor(context.getResources().getColor(android.R.color.primary_text_dark));//, context.getTheme()));
        m_pUI.m_pText2.setTextColor(context.getResources().getColor(R.color.link_text_light));//, context.getTheme()));
        m_pUI.m_pText2.setTextSize(20);
    ...
    public void FixLayout(int l, int t, int r, int b)
    {
        ...
        m_pUI.m_pText2.setGravity(Gravity.CENTER);
        m_pUI.m_pText2.setWidth(500);
//        if(m_bDoubleScale)
//        {
