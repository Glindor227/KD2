...
{
	private static int door_unblock = getIndDisC(R.drawable.door_unblock_p,R.drawable.door_unblock_2,R.drawable.door_unblock,R.drawable.door_unblock_c);
	private static int door_block = getIndDisC(R.drawable.door_block_p,R.drawable.door_block_2,R.drawable.door_block,R.drawable.door_block_c);
	private static int door_free= getIndDisC(R.drawable.door_free_p,R.drawable.door_free_2,R.drawable.door_free,R.drawable.door_free_c);
