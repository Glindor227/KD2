...
public class Curtains extends BaseRelay
{
	...
	{
		super(iX, iY,
				getIndDis(R.drawable.curtains_close_p,R.drawable.curtains_close,R.drawable.id066),
				getIndDis(R.drawable.curtains_open_p,R.drawable.curtains_open,R.drawable.id067),
